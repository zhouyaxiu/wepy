...
var _promisePolyfill = __wepy_require(4);

var _promisePolyfill2 = _interopRequireDefault(_promisePolyfill);

var _wepyRedux = __wepy_require(5);

var _store = __wepy_require(6);
...
var _default = function (_wepy$app) {
  ...
  _createClass(_default, [{
    ...
    value: function onLoad() {
      _wepy2.default.request('https://news-at.zhihu.com/api/4/news/latest').then(function (d) {
...
__wepy_require(2).default.$createApp(_default, {"routes":{"pages/index":8},"style":[7,16,23,40,43,44,46,47,65],"components":{},"apis":{}}, {"noPromiseAPI":["createSelectorQuery"]});
...
var _app = __wepy_require(24);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(25);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(26);

var _component2 = _interopRequireDefault(_component);

var _event = __wepy_require(27);

var _event2 = _interopRequireDefault(_event);

var _base = __wepy_require(28);

var _base2 = _interopRequireDefault(_base);

var _util = __wepy_require(29);

var _util2 = _interopRequireDefault(_util);

var _mixin = __wepy_require(30);

var _mixin2 = _interopRequireDefault(_mixin);

var _wx = __wepy_require(31);
...
var g = __wepy_require(32);

if (!g.Promise) {
  // IOS 10.0.1 may cause IOS crash.
  g.Promise = __wepy_require(4);
}
if (!g.regeneratorRuntime) {
  g.regeneratorRuntime = __wepy_require(33);
}
...
/***** module 5 start *****/
/***** node_modules\wepy-redux\lib\index.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';

exports.__esModule = true;
exports.mapActions = exports.mapState = exports.getStore = exports.setStore = exports.connect = undefined;

var _connect = __wepy_require(34);

var _connect2 = _interopRequireDefault(_connect);

var _store = __wepy_require(35);

var _helpers = __wepy_require(36);
...
var _redux = __wepy_require(37);

var _reduxPromise = __wepy_require(38);

var _reduxPromise2 = _interopRequireDefault(_reduxPromise);

var _reducers = __wepy_require(39);
...
var _panel = __wepy_require(9);

var _panel2 = _interopRequireDefault(_panel);

var _counter = __wepy_require(10);

var _counter2 = _interopRequireDefault(_counter);

var _list = __wepy_require(11);
...
var _group = __wepy_require(12);

var _group2 = _interopRequireDefault(_group);

var _test = __wepy_require(13);

var _test2 = _interopRequireDefault(_test);

var _wepyComToast = __wepy_require(14);

var _wepyComToast2 = _interopRequireDefault(_wepyComToast);

var _test3 = __wepy_require(15);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.$repeat = {};
  this.$props = { "counter2": { "v-bind:num.sync": "mynum" }, "group": { "v-bind:grouplist.once": "item", "v-bind:indexa.once": "index" }, "test": { "xmlns:v-bind": "", "v-bind:title.once": "parentTitle", "v-bind:syncTitle.sync": "parentTitle", "v-bind:twoWayTitle.once": "parentTitle", "bindclickItem": "toTest", "title": "mytest" } };
  this.$events = {};
  this.components = {
  ...
  this.mixins = [_test4.default];
  this.data = {
    mynum: 20,
    list: [{ id: 1, title: 'title' }, { id: 2, title: 'title2' }],
    parentTitle: 'p-title',
    userInfo: {
      nickName: '加载中...'
    },
  ...
  this.methods = {
    ...
    toTest: function toTest(item, index) {
...
var _counter = __wepy_require(41);

var _actions = __wepy_require(42);
...
var _groupitem = __wepy_require(45);
...
var Test = function (_wepy$component) {
  ...
  function Test() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Test.__proto__ || Object.getPrototypeOf(Test)).call.apply(_ref, [this].concat(args))), _this), _this.data = {
      ...
      a: function a(newValue, oldValue) {
  ...
  _createClass(Test, [{
    ...
    value: function test() {
      ...
      Promise.all([promise, promise1]).then(function (result) {
...
exports.default.template=__wepy_require(22);
},/***** module 14 end *****/
...
/***** module 18 start *****/
/***** src\components\counter.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n  <div :class=\"'counter ' + (style)\">\n    <button @click=\"plus($event)\" size=\"mini\">  +  </button>\n    <button @click=\"minus($event)\" size=\"mini\">  -  </button>\n    <button @click=\"incNum($event)\" size=\"mini\">  INCREMENT  </button>\n    <button @click=\"decNum($event)\" size=\"mini\">  DECREMENT  </button>\n    <button @click=\"asyncInc($event)\" size=\"mini\">  ASYNC INCREMENT  </button>\n    <span class=\"count\"> {{num}} </span>\n    <span class=\"count\"> {{stateNum}} </span>\n    <span class=\"count\"> {{asyncNum}} </span>\n  </div>\n"},/***** module 18 end *****/
...
/***** module 21 start *****/
/***** src\components\test.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n  <div class=\"wepy-list\">\n    test页面\n    <slot name=\"title\">默认标题</slot>\n    <slot name=\"content\">默认内容</slot>\n    <div @click=\"test1($event)\">点击测试</div>\n    <div>{{aPlus}}</div>\n    <div @click=\"clickItem(item,index,$event)\" v-for=\"(index, item) in (items)\">\n      {{item.name}}dad\n    </div>\n  </div>\n"},/***** module 21 end *****/
...
var _component2 = __wepy_require(26);
...
var _vue = __wepy_require(50);

var _vue2 = _interopRequireDefault(_vue);

var _vueRouter = __wepy_require(51);
...
var _axios = __wepy_require(53);

var _axios2 = _interopRequireDefault(_axios);

var _query = __wepy_require(54);

var _device = __wepy_require(55);
...
/***** module 34 start *****/
/***** node_modules\wepy-redux\lib\connect\index.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
/***** module 35 start *****/
/***** node_modules\wepy-redux\lib\store.js *****/
function(module, exports, __wepy_require, process, global) {"use strict";
...
/***** module 36 start *****/
/***** node_modules\wepy-redux\lib\helpers\index.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
var _createStore = __wepy_require(56);

var _createStore2 = _interopRequireDefault(_createStore);

var _combineReducers = __wepy_require(57);

var _combineReducers2 = _interopRequireDefault(_combineReducers);

var _bindActionCreators = __wepy_require(58);

var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);

var _applyMiddleware = __wepy_require(59);

var _applyMiddleware2 = _interopRequireDefault(_applyMiddleware);

var _compose = __wepy_require(60);

var _compose2 = _interopRequireDefault(_compose);

var _warning = __wepy_require(61);
...
var _fluxStandardAction = __wepy_require(62);
...
var _counter = __wepy_require(63);
...
var _counter = __wepy_require(64);
...
exports.default.template=__wepy_require(48);
},/***** module 45 end *****/
...
var _isPlainObject = __wepy_require(66);

var _isPlainObject2 = _interopRequireDefault(_isPlainObject);

var _symbolObservable = __wepy_require(67);
...
var _lodashIsplainobject = __wepy_require(68);
...
var _reduxActions = __wepy_require(69);
...
function(module, exports, __wepy_require, process, global) {var baseGetTag = __wepy_require(70),
    getPrototype = __wepy_require(71),
    isObjectLike = __wepy_require(72);
...
var _ponyfill = __wepy_require(73);
 ...
 */
var baseFor = __wepy_require(74),
    isArguments = __wepy_require(75),
    keysIn = __wepy_require(76);
...
var _combineActions = __wepy_require(77);

var _combineActions2 = _interopRequireDefault(_combineActions);

var _createAction = __wepy_require(78);

var _createAction2 = _interopRequireDefault(_createAction);

var _createActions = __wepy_require(79);

var _createActions2 = _interopRequireDefault(_createActions);

var _createCurriedAction = __wepy_require(80);

var _createCurriedAction2 = _interopRequireDefault(_createCurriedAction);

var _handleAction = __wepy_require(81);

var _handleAction2 = _interopRequireDefault(_handleAction);

var _handleActions = __wepy_require(82);
...
function(module, exports, __wepy_require, process, global) {var Symbol = __wepy_require(83),
    getRawTag = __wepy_require(84),
    objectToString = __wepy_require(85);
...
function(module, exports, __wepy_require, process, global) {var overArg = __wepy_require(86);
 ...
 * Available under MIT license <https://lodash.com/license>
 */
var isArguments = __wepy_require(75),
    isArray = __wepy_require(87);
...
var _invariant = __wepy_require(88);

var _invariant2 = _interopRequireDefault(_invariant);

var _isFunction = __wepy_require(89);

var _isFunction2 = _interopRequireDefault(_isFunction);

var _isSymbol = __wepy_require(90);

var _isSymbol2 = _interopRequireDefault(_isSymbol);

var _isEmpty = __wepy_require(91);

var _isEmpty2 = _interopRequireDefault(_isEmpty);

var _toString = __wepy_require(92);

var _toString2 = _interopRequireDefault(_toString);

var _isString = __wepy_require(93);

var _isString2 = _interopRequireDefault(_isString);

var _constants = __wepy_require(94);
...
var _identity = __wepy_require(95);

var _identity2 = _interopRequireDefault(_identity);

var _isNull = __wepy_require(96);
...
var _isPlainObject = __wepy_require(97);
...
var _isArray = __wepy_require(98);
...
var _isNil = __wepy_require(99);

var _isNil2 = _interopRequireDefault(_isNil);

var _getLastElement = __wepy_require(100);

var _getLastElement2 = _interopRequireDefault(_getLastElement);

var _camelCase = __wepy_require(101);

var _camelCase2 = _interopRequireDefault(_camelCase);

var _arrayToObject = __wepy_require(102);

var _arrayToObject2 = _interopRequireDefault(_arrayToObject);

var _flattenActionMap = __wepy_require(103);

var _flattenActionMap2 = _interopRequireDefault(_flattenActionMap);

var _unflattenActionCreators = __wepy_require(104);
...
var _lodash = __wepy_require(105);
...
var _isUndefined = __wepy_require(106);
...
var _reduceReducers = __wepy_require(107);
...
var _isMap = __wepy_require(108);

var _isMap2 = _interopRequireDefault(_isMap);

var _ownKeys = __wepy_require(109);

var _ownKeys2 = _interopRequireDefault(_ownKeys);

var _flattenReducerMap = __wepy_require(110);
...
function(module, exports, __wepy_require, process, global) {var root = __wepy_require(111);
...
function(module, exports, __wepy_require, process, global) {/** Used for built-in method references. */
var objectProto = Object.prototype;
...
/***** module 92 start *****/
/***** node_modules\redux-actions\lib\utils\toString.js *****/
function(module, exports, __wepy_require, process, global) {"use strict";
...
var _lodash = __wepy_require(112);
...
var _flattenWhenNode = __wepy_require(113);
...
var _hasGeneratorInterface = __wepy_require(114);
...
function(module, exports, __wepy_require, process, global) {var freeGlobal = __wepy_require(115);
...
function(module, exports, __wepy_require, process, global) {/** Detect free variable `global` from Node.js. */
var freeGlobal = typeof global == 'object' && global && global.Object === Object && global;
